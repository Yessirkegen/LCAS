...
from engine import LocomotiveSimulator
from engine_kz8a import KZ8ASimulator
from routes_osm import ROUTES_KZ, ALL_ROUTE_IDS
...
async def simulator_status():
    active = {
        lid: {
            ...
            "fuel_level": round(getattr(sim, 'fuel_level', 0) or 0, 1),
